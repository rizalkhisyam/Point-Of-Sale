          ...
          <div class="owl-carousel video-carousel">
            <div class="single-video">
              <div class="video-part">
                <img class="img-fluid" src="{{url('image/beranda/video-img.jpg')}}" alt="">
                <div class="overlay"></div>
                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=VufDd-QL1c0">
                  <img class="play-icon" src="{{url('image/beranda/play-btn.png')}}" alt="">
                </a>
              </div>
      ...
      <div class="feature-inner row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-blog-post">
            <img src="{{url('image/beranda/blog-post/b1.jpg')}}" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
        ...
        <div class="col-lg-4 col-md-6 mt--160">
          <div class="single-blog-post">
            <img src="{{url('image/beranda/blog-post/b2.jpg')}}" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
        ...
        <div class="col-lg-4 col-md-6 mt--260">
          <div class="single-blog-post">
            <img src="{{url('image/beranda/blog-post/b3.jpg')}}" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
